                                ...
                                <div className="flex flex-col gap-3 md:gap-5 text-left">
                                    ...
                                    <div className="flex gap-3 flex-wrap text-white">
                                        {anime.genres.map((genre, keys) => {
                                            return (
                                                <div className="border-solid border-2 p-1 border-white text-xs md:text-sm font-medium" key={keys}>{genre}</div>
                                            )
                                        })}
                                    </div>
                                    <Link to='/'>
                                        <button className="hidden md:block text-xs md:text-base font-semibold bg-white px-2 md:px-3 md:py-2 py-1 text-black rounded-xl hover:text-white hover:bg-black ease-in duration-150">VIEW DETAILS</button>
                                    </Link>
                                </div>
                            </div>
                        </SwiperSlide>
